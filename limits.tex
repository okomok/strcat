...
The following proposition allows us to call a limit \emph{the} limit.
...
\definitionof{Coproduct}{
    A \emph{coproduct} is a structure obtained from the bijectivity diagram of products flipped.
    \In{align*}{
...
\definitionof{Preservation of Limits}{
    ...
    a functor $G : \cat B \to \cat C$ \emph{preserves limits} of $F$ when
    \In{align*}{
...
\InList{strdproof,align*}{
    ...
    \strdgathered{
        ...
        ,\strdwidecell{1}{1}{g}
        ,\strdtubestart
        ,\strdtubemid,\strdat{Right}{\strdrlabel{B}}
    } =
    \strdgathered{
        \strdfork{
            \strdmid
    ...
    \strdgathered{
        \strdbox{3}{3}{
            ...
            ,\strdtubestart
            ,\strdtubemid,\strdat{Right}{\strdrlabel{B}}
            ,\strdat{Left End}{\strdmid}
        }%,\strdat{Left}{\strdoverlabel{\strdlvert{\operatorname{curry}}}}
    }
}
