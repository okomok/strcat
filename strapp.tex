...
One can check that any diagram build upon these definitions has no ambiguity due to the famous laws:
\In{align*}{
...
For example, a function application $f\,x$ is depicated as
\In{align*}{
    \strdexternal\strdgathered{
        \strdmid,\strdrlabel{b}
        ,\strdcell{f}
...
\definitionof{Functional Box}{
    ...
    an application $k\,h$ can be depicated as a \emph{functional box}:
    \In{align*}{
        \strdexternal\strdgathered{
...
\definitionof{Functorial Tube}{
    ...
    can be depicated as a \emph{functorial tube} defined by 
    \In{align*}{
        \strdexternal\strdgathered{
            \strdfork{
                \strdmid,\strdrlabel{a}
...
We will make string diagrams two-dimentional, equipped with \emph{horizontal composition}.
...
\In{definition}{
    ...
    We don't distinguish \haskprod{a_1}{\haskprod{a_2}{a_3}} from %
    \haskprod{\haskprod{a_1}{a_2}}{a_3} so that any tuple can be depicated as
    \In{align*}{
        \strdexternal\strdgathered{
            \strdfork{
                \strdljump,\strdmid,\strdrlabel{a_1}
...
\definitionof{Horizontal Composition}{
    ...
    Three or more parallel nodes are similarly defined.
}
...
\definitionof{Composition}{
}

\definitionof{Idenitity}{
}
...
Using string diagrams, an $\texttt{Applicative}\,f$ consists of
\In{enumerate}{
...
\In{itemize}{
    ...
    \item \InList{math,aligned}{
        ...
        \strdexternal\strdgathered{
            ...
            \strdtubestartline,
            \strdtube\strdtubemid,
            \strdtube{\strdxscale{2}\strdtuberjump,\strdtubemid,\strdtubeendline}
        }
    }
}

\In{remark}{
    The last law is redundant in case the \emph{free theorem} enabled.
}
...
To depict applicative functors cuter, we represent an applicative functor as a forkable tube, %
...
The laws of applicative functors state nodes freely move in tubes as far as well-typed. %
...
to this equation. A tube that has more forks is similarly defined without ambiguity.
\mynewline
Now we can depict applicative functors using:
\In{proposition}{
    \In{align*}{
        \strdexternal\strdgathered{
            \strdfork{
