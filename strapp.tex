...
\definitionof{Functional Box}{
    ...
    an application $k\,h$ can be depicted as a \emph{functional box}:
    \In{align*}{
        \strdexternal\strdgathered{
...
\definitionof{Functorial Tube}{
    ...
    can be depicted as a \emph{functorial tube} defined by 
    \In{align*}{
        \strdexternal\strdgathered{
            \strdfork{
                \strdmid,\strdrlabel{a}
...
We will make string diagrams two-dimensional, equipped with \emph{horizontal composition}.
...
The following definitions makes bands cute.
...
\mynewline
\indent For later use, we rephrase the two famous operators.
...
The laws of applicative functors represent the following propositions.
...
\propositionof{Naturality}{
    \In{align*}{
        ...
        \strdexternal\strdgathered{ \strdflip{
            \strdfork{
                \strdparallel{
                    \strdseq{\strdljump,\strdmid,\strdmid,\strdat{Mid}{\strdcell{h}}},
                    \strdseq{\strdrjump,\strdydouble\strdmid},
...
A tube that has more forks is similarly defined without ambiguity.
\In{remark}{
