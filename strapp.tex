...
\In{itemize}{
    \item \emph{unitality}: $f\haskdot\texttt{id} = f = \texttt{id}\haskdot f$
    \item \emph{associativity}: $(h\haskdot g) \haskdot f = h\haskdot(g\haskdot f)$
}
...
\In{itemize}{
    ...
    \item $\haskprod{\haskprod{a_1}{a_2}}{a_3} \cong \haskprod{a_1}{\haskprod{a_2}{a_3}}$
}
