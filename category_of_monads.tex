...
\strdexternalname{category_of_monads}
...
\definitionof{Category of Monads}{
...
\definitionof{Monad-Associated Adjunction}{
    Given a monad $(T,\eta,\mu)$, we say an adjunction $F \dashv G$ %
    is \emph{$T$-associated} provided that
    \In{enumerate}{
        \item $T = G \circ F$
        \item $\mu = G \epsilon F$
    }
