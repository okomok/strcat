...
\item \emph{idenitities} or \emph{units}: a family of morphisms
    \In{align*}{
...
An \emph{isomorphism} is a pair of morphisms
\In{align*}{
    f : A \to B\\
    g : B \to A
}
...
\begin{definition}[Functional Box]
