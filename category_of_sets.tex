...
\definitionof{Currying}{
    In particular case $\cat{C} = \catSet$, the \emph{curry bijection} is defined by
    \In{align*}{
...
We don't distinguish these two diagrams, for %
the naturality of this bijection ensures ``move the right-side leg up and down" works correct.

\In{proposition}{
    The curry bijection is natural in all three variables.
}
