...
\definitionof{Uniqueness}{
    ...
    ``$a$ is the unique thing that satisfies $P$".
}

\definitionof{Unique Existential Quantifer}{
    The \emph{unique existential quantifer} $\exists!$ is defined as $\exists \circ !$, %
...
\In{remark}{
    ...
    states ``there exists a unique $a$ that satisfies $P(a)$. Furthermore, the $a$ satisfies $Q(a)$".
}
